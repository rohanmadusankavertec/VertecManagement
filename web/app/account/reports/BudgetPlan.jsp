                    ...
                    <form>
                        ...
                        <div class="item form-group" style="padding-top: 10px;">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="name">State <span class="required"></span>
                                <label class="control-label col-md-4 col-sm-4 col-xs-12" for="name"><%=st%> <span class="required"></span>
                                </label>

                        </div>
                        <div class="item form-group" style="padding-top: 10px;">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="name">Function <span class="required"></span>
                                <label class="control-label col-md-4 col-sm-4 col-xs-12" for="name"><%=fd%> <span class="required"></span>
                                </label>

                        </div>
                        <div class="item form-group" style="padding-top: 10px;">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="name">Cost Center <span class="required"></span>
                                <label class="control-label col-md-4 col-sm-4 col-xs-12" for="name"><%=cc%> <span class="required"></span>
                                </label>

                        </div>
                        <div class="item form-group" style="padding-top: 10px;">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="name">Nominal Code <span class="required"></span>
                                <label class="control-label col-md-4 col-sm-4 col-xs-12" for="name"><%=nc%> <span class="required"></span>
                                </label>

                        </div>
                        <div class="item form-group" style="padding-top: 10px;">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="name">Year <span class="required"></span>
                                <label class="control-label col-md-4 col-sm-4 col-xs-12" for="name"><%=by%> <span class="required"></span>
                                </label>
                        ...
                        <center>
                            <table style="width: 80%;border:1px solid #000 ;border-collapse: collapse;">
                                ...
                                <tbody>
                                    ...
                                    <tr style="border: 1px solid black;">
                                        <td style="border: 1px solid black;height: 8px;padding: 8px;"><strong>Total Amount</strong></td>
                                        <td style="border: 1px solid black;height: 8px;padding: 8px;">0000.00</td>
                                    </tr>
                                </tbody>
                            </table>
                        </center>
