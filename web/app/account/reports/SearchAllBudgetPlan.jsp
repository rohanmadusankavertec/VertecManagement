...
//    List<NominalCode> nc = (List<NominalCode>) request.getAttribute("nominalCode");
    List<Integer> by = (List<Integer>) request.getAttribute("year");
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form action="AccountReport?action=AllBudget" method="POST" >
                        ...
                        <div class="item form-group" style="padding-top: 50px;">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="name">Select Month <span class="required"></span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
