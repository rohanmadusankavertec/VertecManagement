                    ...
                    <form action="AccountReport?action=BudgetPlan" method="POST">
                        ...
                        <div class="item form-group" style="padding-top: 50px;">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="stateid" id="stateid" required="" required="required" onchange="loadFunctionData();">
                        ...
                        <div class="item form-group" style="padding-top: 50px;">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="functionid" id="functionid" required="required" onchange="loadCostCenter();">
                        ...
                        <div class="item form-group" style="padding-top: 50px;">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="ccId" id="ccId" required="required" onchange="">
