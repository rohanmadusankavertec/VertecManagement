...
<%@include file="../../template/sidebar.jsp"%>
    ...
    <%
        List<Quotation> softList = (List<Quotation>) request.getAttribute("Qlist");
    %>
    <div class="">
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Software Quotation <small>up to now</small></h2>
                    ...
                    <div class="table-responsive">
                        <table id="example" class="table table-striped responsive-utilities jambo_table">
                            ...
                            <tbody>
                                ...
                                <% for (Quotation s : softList) {

                                %>
                                <tr>

                                    <td class=" "><%=s.getProjectProposalId().getProposalName() %></td>
                                    <td class=" "><%=s.getProjectProposalId().getCustomerId().getFirstName()+" "+s.getProjectProposalId().getCustomerId().getLastName() %></td>
