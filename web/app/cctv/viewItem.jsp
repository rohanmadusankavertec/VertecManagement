...
<%
            List<CctvCategory> b = (List<CctvCategory>) request.getAttribute("category");
            CctvItems c = (CctvItems) request.getAttribute("item");
%>
<script>
    loadItem();
    function loadItem(){ // load category to select element
        var category = <%=c.getCctvCategoryId().getCategory() %>;
...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Update CCTV Item<small></small></h2>
                ...
                <div class="x_content">
                    ...
                    <form action="CCTV?action=updateItem" method="post" class="form-horizontal form-label-left" novalidate>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input value="<%=c.getName() %>" id="itemname" class="form-control col-md-7 col-xs-12"  data-validate-words="1" name="itemname"  required="required" type="text">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input value="<%=c.getPrice() %>" id="price" class="form-control col-md-7 col-xs-12"  data-validate-words="1" name="price"  required="required" type="text">
                            </div>
                        </div>            
