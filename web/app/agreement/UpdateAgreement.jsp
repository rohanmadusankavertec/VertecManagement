...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Update Agreement<small></small></h2>
                ...
                <div class="x_content">
                    <form action="Agreement?action=SaveAgreement" method="post" class="form-horizontal form-label-left" validate>
                        ...
                        <div class="item form-group">
                            <label for="password2" class="control-label col-md-3 col-sm-3 col-xs-12">Customer</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="customer" required="required" >
                                    ...
                                    <option value="<%=c.getId()%>"><%= " " + c.getCompanyName() + " " + c.getFirstName() + " " + c.getLastName()%></option>
                                    <%}%>
                                </select>                            
                            </div>
                        </div>
